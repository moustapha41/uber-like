...
class GeocodingService {
  static final Dio _dio = Dio(
    BaseOptions(
      ...
      headers: {
        'User-Agent': 'BikeRidePro-Client/1.0',
      },
  ...
  static Future<List<GeocodingResult>> search(
    ...
    if (currentLat == null || currentLng == null) {
      return await _getLocalSuggestions(null, null);
    }
  ...
  /// Enregistre une destination pour "lieux souvent demandés dans la zone".
  ...
  /// Suggestions : historique + destinations fréquentes dans la zone + lieux populaires locaux
  static Future<List<GeocodingResult>> _getLocalSuggestions(
    ...
    if (currentLat != null && currentLng != null) {
      final frequent = await _getFrequentInZone(currentLat, currentLng, _defaultRadiusKm);
      suggestions.addAll(frequent);
    }
  ...
  /// Lieux populaires locaux : aéroport, gare, hôpital, université, école, stade, supermarché, marché, bus, police, boutique, quartiers
  ...
  /// Priorité affichage : lieux populaires en premier
  ...
  /// Reverse geocoding court : retourne "Quartier, Ville" ou "Ville" (idéal pour affichage après un tap sur la carte)
